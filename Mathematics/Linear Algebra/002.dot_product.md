...
### 6. Orthogonal Vectors 🟢 IMPORTANT 🟢

If dot product of two vectors are 0 then they are perpendicular to each other and they are said to be orthogonal vectors.

* if the dot product is positive then the vectors generally said to be in the same direction

* if the dot product is negative then the vectors are generally said to be in the opposite direction
