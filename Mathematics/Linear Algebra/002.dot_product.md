...
so,
$$ projected \space vector = \frac{\vec{a}.\vec{b}}{\Vert\vec{b}\Vert} \times \frac{\vec{b}}{\Vert \vec{b} \Vert} = \frac{\vec{a}.\vec{b}}{{\Vert \vec{b} \Vert}^2} \times \vec{b} = \frac{\vec{a}.\vec{b}}{\vec{b}.\vec{b}} \vec{b} $$
