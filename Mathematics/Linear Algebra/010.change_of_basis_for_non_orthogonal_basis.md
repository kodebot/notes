...
* **Step 3:** take $\vec{v_3}$, it will be popping out from the plane created by $\vec{u_1}$ and $\vec{u_2}$ as the original basis vectors are linearly independent. Now if we can project $\vec{v_3}$ onto the plane created by $\vec{u_1}$ and $\vec{u_2}$
