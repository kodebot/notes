...
* **Step 2:** take $\vec{v_2}$ and project that onto $\vec{u_1}$, now subtracting the projection from $\vec{v_2}$ will give us a new orthogonal vector and normalising it will give us new orthonormal vecotr
