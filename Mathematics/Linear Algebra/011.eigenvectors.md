...
Eigenvector can be defined in the context of matrix transformation such that when the transformation is applied, the vector may be scaled but direction remains the same.
...
This is limited to square matrices.
...
This is very useful property when we need to apply matrix transformation repeatedly. We just need to find $D^2$ and perform matrix operation just once. This is quick and computationally efficient.