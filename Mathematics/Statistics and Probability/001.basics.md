...
* example:
  * 50<sup>th</sup> percentile means 50% of the data are as small or smaller
    * this is also median
    * repeated values can occur

  ![Image 50th Percentile](img/001.basics-1003073733.png)
  * 75<sup>th</sup> percentile means 75% of the data are as small or smaller and 25% of data are as large or larger