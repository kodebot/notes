...
* sometimes we cannot use same experimental unit
  * example in sleep derivation study (involving sleep deprived group and a control group and subject is expected to answer some questions at the end) - here same subject cannot be used for both sleep deprived and control group as they already know the questions
...
* order of experiment is not fixed
  ...
  * and other car may be experimented with performance first then regular
  ...
  ![Image Type of experiments](img/006.experiment-1203093550.png)