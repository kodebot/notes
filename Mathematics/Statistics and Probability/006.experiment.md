...
* sometimes we cannot use same experimental unit
  * example in sleep derivation study (involving sleep deprived group and a control group) - if human is expected to answer some questions at the end then same subject cannot be used again as they already know the questions
